...
namespace HaruhiChokuretsuLib.Audio.SDAT
{
    ...
    /// Bank.
    /// </summary>
    public class Bank : IOFile, IPlayableBank
    {
        ...
        public override void Read(FileReader r)
        {
            ...
            for (int i = 0; i < records.Count; i++)
            {
                ...
                switch (records[i])
                {
                    ...
                    //Blank.
                    case SDAT.Instruments.InstrumentType.Blank:
                        break;

                    //Direct.
                    case SDAT.Instruments.InstrumentType.PCM:
                    case SDAT.Instruments.InstrumentType.PSG:
                    case SDAT.Instruments.InstrumentType.Noise:
                    case SDAT.Instruments.InstrumentType.DirectPCM:
